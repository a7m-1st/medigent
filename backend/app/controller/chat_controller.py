...
async def websocket_chat(ws: WebSocket):
    ...
    """
    await ws.accept()
    chat_logger.info("[WS] WebSocket connection accepted")
    ...
    async def _consume_sse_and_forward():
        ...
        try:
            ...
            chat_logger.info("[WS] SSE consumer cancelled")
        except WebSocketDisconnect:
            chat_logger.info("[WS] Client disconnected during SSE consume")
    ...
    try:
        while True:
            ...
            # ----------------------------------------------------------
                ...
                if task_lock is not None:
                    ...
                    chat_logger.info("[WS] stop queued")
            ...
            # ----------------------------------------------------------
                ...
                chat_logger.info("[WS] human_reply delivered")
        ...
        chat_logger.info("[WS] Client disconnected")
    except Exception as exc:
        chat_logger.error(f"[WS] Unexpected error: {exc}", exc_info=True)
    finally:
        ...
        chat_logger.info("[WS] Cleanup complete")
